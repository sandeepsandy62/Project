...
function ThesesChart(){
  ...
  const fetchPhdData = async () => {
    const response = await fetch("http://localhost:8000/phddata")
    const phddata = await response.json()
    setPhdData(phddata.data)
  }
